                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center gap-2">
                                <img src="<?= htmlspecialchars(imgUrl($rv['thumbnail'] ?? '')) ?>"
                        ...
                        <td>
                            ...
                            <span style="font-size:12px;color:#8a96b8;margin-left:4px;"><?= $rv['rating'] ?>/5</span>
                        </td>
                        <td style="max-width:200px;font-size:12.5px;color:#4a5568;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">
                            <?= htmlspecialchars($rv['content'] ?? '—') ?>
                        </td>
                        <td style="font-size:12px;color:#8a96b8;"><?= date('d/m/Y', strtotime($rv['created_at'])) ?></td>
                        <td>
