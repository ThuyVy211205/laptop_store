            ...
            <div class="admin-table-wrap">
                <table class="admin-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="font-weight:600;"><?= htmlspecialchars($e['ho_ten']) ?></div>
                            <div style="font-size:11.5px;color:#8a96b8;"><?= htmlspecialchars($e['thu_dien_tu']) ?></div>
                        </td>
                        <td><?= htmlspecialchars($e['so_dien_thoai'] ?? '—') ?></td>
                        <td><?= htmlspecialchars($e['vai_tro']) ?></td>
                        <td style="font-size:12.5px;color:#8a96b8;"><?= date('d/m/Y', strtotime($e['ngay_tao'])) ?></td>
                        <td>
                            <span class="badge-status <?= $e['trang_thai'] ?>">
                                <?= $e['trang_thai'] === 'active' ? 'Hoạt động' : 'Bị khóa' ?>
                            </span>
                        </td>
                        <td>
...
function openEditModal(e) {
    ...
    document.getElementById('empName').value = e.ho_ten || '';
    document.getElementById('empEmail').value = e.email || '';
    document.getElementById('empPhone').value = e.so_dien_thoai || '';
    document.getElementById('empRole').value = e.vai_tro || '';
    document.getElementById('empStatus').value = e.trang_thai || 'active';
    document.getElementById('empPassword').value = '';
