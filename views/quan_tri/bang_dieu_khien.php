    ...
    <div class="admin-main">
        ...
        <header class="admin-topbar">
            ...
            <div class="admin-topbar-title">
                <h5>Dashboard</h5>
                <small>Chào mừng trở lại, <?= htmlspecialchars($admin['ho_ten']) ?>!</small>
            </div>
        ...
        <div class="admin-content">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-card-body">
                        <div class="stat-card-value"><?= number_format($stats['tong_don_hang'] ?? 0) ?></div>
                            ...
                            <?php if (!empty($topProducts)): ?>
                                ...
                                <div class="mini-stat">
                                    ...
                                    <div class="mini-stat-info">
                                        ...
                                        <div class="mini-stat-sub">Đã bán: <?= number_format($p['so_luong_ban']) ?></div>
                                    </div>
                    ...
                    <table class="admin-table">
                        ...
                        <?php if (!empty($recentOrders)): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="font-weight:600;color:#1e2a3b;"><?= htmlspecialchars($order['ten_giao_hang']) ?></div>
                                    <div style="font-size:12px;color:#8a96b8;"><?= htmlspecialchars($order['sdt_giao_hang']) ?></div>
                                </td>
                                <td>
                                    <strong style="color:#059669;"><?= formatPrice($order['tong_tien']) ?></strong>
                                </td>
                                <td>
                                ...
                                <td>
                                    <span class="badge-status <?= htmlspecialchars($order['trang_thai']) ?>">
                                        <?= $statusLabels[$order['trang_thai']] ?? $order['trang_thai'] ?>
                                    </span>
                                </td>
                                <td style="color:#8a96b8;font-size:12.5px;"><?= formatDateTime($order['ngay_tao']) ?></td>
                                <td>
