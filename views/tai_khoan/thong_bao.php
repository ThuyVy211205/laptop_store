            ...
            <div class="checkout-card">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h5 class="checkout-card-title mb-0">
                        ...
                        <?php
                        $unread = array_filter($notifications, fn($n) => !$n['da_doc']);
                        if (count($unread) > 0):
                        ?>
                ...
                <div class="notification-list">
                    ...
                    <?php
                        ...
                        $typeColor = '#6b7280';
                        if ($n['loai'] === 'order')      { $typeIcon = 'fas fa-box';           $typeColor = '#2563eb'; }
                        if ($n['loai'] === 'admin_mail') { $typeIcon = 'fas fa-envelope';      $typeColor = '#7c3aed'; }
                        if ($n['loai'] === 'info')       { $typeIcon = 'fas fa-info-circle';   $typeColor = '#0891b2'; }
                        if ($n['loai'] === 'success')    { $typeIcon = 'fas fa-check-circle';  $typeColor = '#16a34a'; }
                    ?>
                    <div class="notification-item <?= $n['da_doc'] ? '' : 'unread' ?>"
                         data-id="<?= $n['id'] ?>"
                        ...
                        <div style="flex:1;min-width:0;">
                            <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:8px;">
                                <div style="font-weight:<?= $n['da_doc'] ? '500' : '700' ?>;font-size:14px;color:#1e2a3b;line-height:1.4;">
